...
const expectedLight: Record<string, V2ColorValue> = {
...
const expectedDark: Record<string, V2ColorValue> = {
...
describe("V2 color mapping", () => {
  test("refactor preserves the original light and dark mappings", () => {
    expect(mapV2Semantics(false)).toEqual(expectedLight)
    expect(mapV2Semantics(true)).toEqual(expectedDark)
  })
})